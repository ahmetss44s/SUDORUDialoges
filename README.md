...
[![Version](https://img.shields.io/badge/Версия-1.0.3-gold?style=for-the-badge)](https://github.com/ahmetss44s/SUDORUDialoges/releases/tag/v1.0.3)
...
1. Скачай последний релиз [`SUDORUDialoges-1.0.3.jar`](https://github.com/ahmetss44s/SUDORUDialoges/releases/tag/v1.0.3) из [Releases](../../releases)
